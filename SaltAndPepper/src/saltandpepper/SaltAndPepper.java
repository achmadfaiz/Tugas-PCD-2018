...
public class SaltAndPepper {
	...
	BufferedImage image1 = ImageIO.read(new File("D:\\INFORMATICS ENGINEERING\\SEMESTER 7\\PCD (Tahsin)\\tugas besar image processing\\fruits.png"));
	...
	for(int i=0; i<height; i++){
			...
			try{
			      f = new File("D:\\INFORMATICS ENGINEERING\\SEMESTER 7\\PCD (Tahsin)\\tugas besar image processing\\saltpepper.png");
